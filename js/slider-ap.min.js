(function(){function e(b,c){this.selector=null;c?this.nodes=c:"string"==typeof b?(this.selector=b,this.nodes=document.querySelectorAll(b)):this.nodes=[b];this.length=this.nodes.length;this.el=this.nodes[0]}function d(b){return new e(b)}function k(b,c){function l(a,c,d){a=a||{};e();!1!==c&&r();N=n=f=null;p=-1;C=z=D=E=null;A=!1;B=null;F=!1;q=null;k(a);u();S(f.transition_type,!0);n.find("#"+b+" .ap-caption").css("visibility","hidden");T();ca();x(f.play_type);da();setTimeout(function(){!0!==d&&h()},
1E3)}function e(){d("#"+b+"-ap-loading-mask").remove();var a=document.createElement("DIV");a.id=b+"-ap-loading-mask";a.style.position="absolute";a.style.zIndex=10;a.style.top=0;a.style.bottom=0;a.style.left=0;a.style.right=0;a.style.backgroundColor="#eee";d("#"+b).el.appendChild(a)}function h(){d("#"+b).show();1==d("#"+b+"-ap-loading-mask").length&&d("#"+b+"-ap-loading-mask").fadeOut(400,function(){d("#"+b+"-ap-loading-mask").remove();O(0);U(0)})}function k(a){for(var c in G){var g=typeof G[c];
void 0==a[c]&&"object"!=g&&(g=d("#"+b).data(c),void 0!=g&&("true"===g?g=!0:"false"===g&&(g=!1),a[c]=g))}f=a||{};for(c in G)void 0==f[c]&&(f[c]=G[c]);f.captions=[];a=d("#"+b+" ol > li");c=a.length;for(g=0;g<c;g++){f.captions[g]=[];for(var l=0;3>l;l++){var e={enable:V[l].enable,delay:V[l].delay},t=d(a.get(g)).find(".ap-caption-"+l);1==t.length&&(e.enable=!0,t=t.data("delay"),isNaN(t)||(e.delay=parseInt(t)));f.captions[g][l]=e}}}function r(){g();W();q&&q.unbindEventListeners();X();d("#"+b+" .ap-radios input.ap-radio, #"+
b+" .ap-radios .ap-radio-label").off("click",H);d("#"+b+" .ap-radios input.ap-radio, #"+b+" .ap-radios .ap-radio-label").off("touchstart",H);Y();d("#"+b+" .ap-button").remove();d("#"+b+" .ap-radios").remove();d("#"+b+" .ap-cloned").remove();for(d("#"+b+" .ap-tmp-clone").remove();0<d("#"+b+" .ap-frame").length;)d("#"+b+" .ap-slides").unwrap();0<d("#"+b+" .ap-img-frame").length&&d("#"+b+" .ap-img").unwrap();d("#"+b+" .ap-caption").removeAttr("style");d("#"+b+" .ap-slide").show();d("#"+
b+" .ap-slide").removeAttr("style");d("#"+b+" .ap-slides").removeAttr("style");d("#"+b+" .ap-img").removeClass("ap-img");d("#"+b+" .ap-slide").removeClass("ap-slide ap-slide-0 ap-slide-1 ap-slide-2 ap-slide-3 ap-slide-4 ap-slide-5 ap-slide-6 ap-slide-7 ap-slide-8 ap-slide-9");d("#"+b+" .ap-slides").removeClass("ap-slides");d("#"+b).removeClass("active")}function u(){n=d("#"+b+" ol");N=100/d("#"+b+" ol > li").length;p=0;n.addClass("ap-slides");d("#"+b+" .ap-slides > li").addClass("ap-slide");
d("#"+b+" .ap-slides > .ap-slide > img, #"+b+" .ap-slides > .ap-slide > a > img").addClass("ap-img");n.find("li").each(function(a){this.addClass("ap-slide-"+a)});d("#"+b).wrapInner("<div class='ap-frame'></div>");n=d("#"+b+" ol.ap-slides");d("#"+b+" .ap-img").wrap("<div class='ap-img-frame'></div>")}function m(){return d("#"+b+" .ap-slide").length}function x(a){f.play_type=a;Y();d("#"+b+" .ap-pause-button").remove();f.pause_button&&"manual"!=f.play_type&&(n.after("<div class='ap-pause-button'>&nbsp;</div>"),
C=d("#"+b+" .ap-pause-button"),C.on("click",I),C.on("touchstart",I));v()}function v(){A=!0;d("#"+b+" .ap-pause-button").removeClass("ap-play");"manual"!=f.play_type&&(clearTimeout(B),B=setTimeout(a,f.interval))}function a(){var a=p+1;A&&"manual"!=f.play_type&&("once"==f.play_type&&p==m()-2?(y(a),g()):"once-rewind"==f.play_type&&p==m()-1?(y(0),g()):("loop"==f.play_type&&p==m()-1?y(0):y(a),v()))}function g(){A=!1;clearTimeout(B);B=null;d("#"+b+" .ap-pause-button").addClass("ap-play")}function t(a,
b){a!=p&&(g(),y(a,b))}function T(){f.buttons&&(n.after("<div class='ap-button ap-button-prev'>&nbsp;</div><div class='ap-button ap-button-next'>&nbsp;</div>"),E=d("#"+b+" .ap-button-prev"),D=d("#"+b+" .ap-button-next"),E.on("click",J),E.on("touchstart",J),D.on("click",K),D.on("touchstart",K))}function X(){d("#"+b+" .ap-button-prev").off("click",J);d("#"+b+" .ap-button-prev").off("touchstart",J);d("#"+b+" .ap-button-next").off("click",K);d("#"+b+" .ap-button-next").off("touchstart",K)}function J(a){a&&
a.preventDefault&&a.preventDefault();a&&a.stopPropagation&&a.stopPropagation();t(p-1)}function K(a){a&&a.preventDefault&&a.preventDefault();a&&a.stopPropagation&&a.stopPropagation();t(p+1)}function ca(){if(f.radios){d("#"+b).append("<ul class='ap-radios'></ul>");z=d("#"+b+" .ap-radios");"thumbnail"==f.radio_type&&z.addClass("ap-radios-as-thumbnails");for(var a=0;a<m();a++)0==a?z.append("<li class='ap-radio-"+a+" active'><input type='radio' name='ap-radio' class='ap-radio' id='ap-radio-"+a+
"' checked='checked' /><label class='ap-radio-label' for='ap-radio-"+a+"'></label></li>"):z.append("<li class='ap-radio-"+a+"'><input type='radio' name='ap-radio' class='ap-radio' id='ap-radio-"+a+"' /><label class='ap-radio-label' for='ap-radio-"+a+"'></label></li>");d("#"+b+" .ap-radios input.ap-radio, #"+b+" .ap-radios .ap-radio-label").on("click",H);d("#"+b+" .ap-radios input.ap-radio, #"+b+" .ap-radios .ap-radio-label").on("touchstart",H)}}function H(a){a.preventDefault&&a.preventDefault();
a.stopPropagation&&a.stopPropagation();a=d(a.target.parentNode).index();t(a)}function Z(a){f.radios&&(d("#"+b+" .ap-radios li").removeClass("active"),a=d("#"+b+" .ap-radios li").get(a),d(a).addClass("active"),d(a).find("input").attr("checked","checked"))}function Y(){d("#"+b+" .ap-pause-button").off("click",I);d("#"+b+" .ap-pause-button").off("touchstart",I)}function I(a){a.preventDefault();a.stopPropagation();A?g():v()}function da(){var a=d("#"+b).get(0),c=n.get(0);q=new Dragdealer(a,c,{steps:m(),
...
a!=f.transition_type){f.transition_type=a;d("#"+b+" .ap-slide").removeClass("ap-zoom-in");d("#"+b+" .ap-slide").show();var g=m();n.css("width",100*g+"%");n.find(".ap-slide").each(function(a){a=N*a+"%";this.css("width",100/g+"%");this.css("left",a)})}}function y(a,b){if(!0!==F&&a!=p){F=!0;var c=p;a=parseInt(a);0>a?a=m()-1:a>=m()&&(a=0);var g=a;Z(g);p=g;P("beforetransition",[g]);"instant"==f.transition_type?(g=a,q.setStep(g+1,1,!0),L(c,g,!0,b)):"slide"==f.transition_type?ea(c,a,b):"fade"==f.transition_type?
ba(c,a,!1,b):"zoom"==f.transition_type&&ba(c,a,!0,b)}}function ea(a,b,c){var g=b/(m()-1);q.startSlide(g,function(){L(a,b,!0,c)})}function ba(a,c,g,l){d("#"+b+" li.ap-slide").removeClass("ap-zoom-in");var t=d("#"+b+" li.ap-slide-"+a),e=n.clone();e.addClass("ap-slides-clone");var h=c/(m()-1),h=q.getOffsetsByRatios([h,0]);e.css("transform","translateX("+h[0]+"px)");e.insertAfter(n.el);g&&t.addClass("ap-zoom-in");g=e.get(0);n.fadeInto(g,2*f.transition_duration,function(){q.setStep(c+1,1,!0);d("#"+
b+" .ap-slides-clone").remove();d("#"+b+" .ap-slides").show();d("#"+b+" .ap-slides").css("opacity",null);L(a,c,!0,l)})}function L(a,c,g,l){c=parseInt(c);d("#"+b+" .ap-slides-clone").remove();d("#"+b+" .ap-slides").show();d("#"+b+" li.ap-slide").removeClass("ap-zoom-in");g&&aa();l&&l();O(c);U(c);F=!1;P("aftertransition",[c])}function O(a){W();"none"!=f.image_fx&&("zoompan"==f.image_fx?d("#"+b+" .ap-slide-"+a+" .ap-img-frame").addClass("ap-zoom-pan"):"zoomrotate"==f.image_fx&&d("#"+b+" .ap-slide-"+
a+" .ap-img-frame").addClass("ap-zoom-rotate"))}function W(){d("#"+b+" .ap-slide .ap-img-frame").removeClass("ap-zoom-pan");d("#"+b+" .ap-slide .ap-img-frame").removeClass("ap-zoom-rotate")}function U(a){n.find(".ap-caption").css("visibility","hidden");n.find(".ap-caption").removeClass("ap-caption-anim");R(a,0);R(a,1);R(a,2)}function R(a,b){f.captions[a]&&1==f.captions[a][b].enable&&setTimeout(function(){n.find(".ap-slide-"+a+" .ap-caption-"+b).css("visibility","visible");n.find(".ap-slide-"+
a+" .ap-caption-"+b).addClass("ap-caption-anim")},f.captions[a][b].delay)}var G={transition_type:"slide",play_type:"manual",interval:7E3,image_fx:"none",buttons:!0,radios:!0,radio_type:"button",pause_button:!0,transition_duration:350,swipe:!0},V=[{enable:!1,delay:0},{enable:!1,delay:200},{enable:!1,delay:400}],f,n,N,p,E,D,z,C,A,B,F,q,Q={};l(c,!1,c.prevent_stop_loading||!1);this.init=l;this.deinit=r;this.stopLoading=h;this.transition=y;this.listen=function(a,b){Q[a]=b};this.reflow=aa;this.setTransitionType=
S;this.setPlayType=x;this.setInterval=function(a){f.interval=a};this.setImageFx=function(a){a!=f.image_fx?(f.image_fx=a,O(p)):f.image_fx=a};this.setCaptionEnable=function(a,b,c){f.captions[a][b].enable=c};this.setCaptionDelay=function(a,b,c){f.captions[a][b].delay=c};this.enableButtons=function(a){!0!==a||f.buttons||(X(),d("#"+b+" .ap-button").remove(),T())};this.enableRadios=function(a){};this.setRadioType=function(a){"thumbnail"==a?d("#"+b+" .ap-radios").addClass("ap-radios-as-thumbnails"):d("#"+
b+" .ap-radios").removeClass("ap-radios-as-thumbnails")};this.getSlideCount=m;this.getActiveSlideIndex=function(){return p};this.setElementId=function(a){b=document.getElementById(b).id=a}}e.prototype.get=function(b){return this.nodes[b]};e.prototype.find=function(b){b=this.el.querySelectorAll(b);return new e(null,b)};e.prototype.index=function(){for(var b=this.el,c=0;null!=(b=b.previousSibling);)c++;return c};e.prototype.each=function(b){for(var c=0;c<this.nodes.length;c++){var d=new e(this.nodes[c]);
...
function(b){"complete"===document.readyState?setTimeout(b,1):document.addEventListener?document.addEventListener("DOMContentLoaded",b,!1):document.attachEvent("onreadystatechange",function(){"complete"===document.readyState&&b()})};window.ap=window.ap||{};window.ap.Slider=k;window.ap.Config=window.ap.Config||{};window.ap.instances=[];d.ready(function(){if(!0!==window.ap.Config.no_instantiation)for(var b=d(".ap-slider"),c=0;c<b.length;c++){var e=b.get(c);e.id=e.id||"ap-slider-"+c;window.ap.instances.push(new k(e.id,
{}))}})})();
...
"click",this.onHandleClick);c(window,"resize",this.onWindowResize);this.cancelAnimationFrame(this.interval)},onHandleMouseDown:function(a){a.target&&"A"==a.target.tagName&&0<=a.target.className.search(/ap-caption/)&&(document.location=a.target.href);h.refresh(a);l(a);M(a);this.activity=!1;this.startDrag()},onHandleTouchStart:function(a){a.target&&"A"==a.target.tagName&&0<=a.target.className.search(/ap-caption/)&&(document.location=a.target.href);h.refresh(a);M(a);this.activity=!1;this.startDrag()},
onDocumentMouseMove:function(a){h.refresh(a);this.dragging&&(this.activity=!0,l(a))},onWrapperTouchMove:function(a){h.refresh(a);!this.activity&&this.draggingOnDisabledAxis()?this.dragging&&this.stopDrag():(l(a),this.activity=!0)},onWrapperMouseDown:function(a){a.target&&0<=a.target.className.search(/ap-(button|radio|caption)/)||(h.refresh(a),l(a),this.startTap())},onWrapperTouchStart:function(a){h.refresh(a);l(a);this.startTap()},onDocumentMouseUp:function(a){this.stopDrag();this.stopTap();a.target&&
0<=a.target.className.search(/ap-(button|radio|caption)/)||this.options.afterSwipeCallback()},onDocumentTouchEnd:function(a){this.stopDrag();this.stopTap();this.options.afterSwipeCallback()},onHandleClick:function(a){a.target&&0<=a.target.className.search(/ap-(button|radio)/)||!this.activity||(l(a),M(a))},onWindowResize:function(a){this.reflow()},enable:function(){this.disabled=!1;this.handle.className=this.handle.className.replace(/\s?disabled/g,"")},disable:function(){this.disabled=!0;this.handle.className+=
...
window[u[v]+"CancelRequestAnimationFrame"];m||(m=function(a){return setTimeout(a,300)},x=clearTimeout);return d});

//==========auto slide==========
$(document).ready(function(){
	setInterval(function(){
		$(".ap-button-next").click();
	}, 3000);
});
